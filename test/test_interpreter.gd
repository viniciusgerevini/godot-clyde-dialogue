...
""")
	interpreter.init(content)
	interpreter.on_external_variable_update(func (variable_name, value):
		assignment.var = variable_name
...
""")
	...
	interpreter.on_external_variable_fetch(func (_variable_name):
		return 43
	)
