...
export var _dialogue_bubble_container: NodePath
...
func get_config() -> Dictionary:
	return {
		...
		"bubble_container": self.get_parent().get_path() if not self.has_node(_dialogue_bubble_container) else _dialogue_bubble_container,
		"input": {
